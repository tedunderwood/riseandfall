...
outmeta.to_csv('mallet80metadata4experiment2.tsv', sep = '\t', index_label = 'docid')
...
with open('kirkus_delta_vocabulary.tsv', mode = 'w', encoding = 'utf-8') as f:
...
for docid, wordfreqs in termfreqs.items():
    ...
    # termvector = termvector / docvector no IDF
...
outdf.to_csv('delta_matrix_4kirkus.tsv', sep = '\t', index_label = 'docid')
